...
| `PAPER_ZONE_SCORE` | on (`0` disables) | Rank MAP accept by 7-day family paper score when history exists |
...
`replay-map` walks 4H detect → policy → 15m ARM on the same tape. Quant missing. `*-replay-map.sqlite`.
