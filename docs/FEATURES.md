...
| Paper replay-map | Live | `bun run paper replay-map SYMBOL --from --to` — walk confirmed 4H detect → MAP policy → 15m ARM/OCO. No future bars. Quant tape missing (not invented). Slippage 0. Separate `*-replay-map.sqlite`. |
