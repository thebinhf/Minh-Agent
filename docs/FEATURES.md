...
| SQLite storage | Live | Feed: 4 MiB page cache, no mmap, WAL ≤8 MiB + autocheckpoint ~2 MiB; prune checkpoints, shrink_memory, VACUUM when freelist ≥15%. Ticker tape off; book snaps on timer. |
