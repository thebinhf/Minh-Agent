...
| Paper trading | Live | `src/paper/` — virtual USDT ledger, 2–5% risk, MTF tags, Phase 2 fees/funding/multi-TP/leverage from account config. CLI + `127.0.0.1:43181`. No keys, no real orders. See [paper-trading.md](paper-trading.md). |
...
| [paper-trading.md](paper-trading.md) | Paper trading spec (MVP + Phase 2: fees, funding, multi-TP, leverage) |
